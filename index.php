...
<html lang="en">
<head>
<script defer data-domain="scrubclean.site" src="https://plausible.io/js/plausible.js"></script>
            ...
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Microsoft: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support <span
                            style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-888-577-4188 (Toll Free)</span></span>
            </div>
        </div>
        <div class="col-md-12">
...
<div id="poptxt" class="lightbox">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support:+1-888-577-4188 (Toll Free)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Call Microsoft Support: <strong>
           +1-888-577-4188 (Toll Free) </strong></p>
